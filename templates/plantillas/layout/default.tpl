	...
	<div class="wrapper">
		<header class="main-header">
			...
			<a href="panelPrincipal" class="logo">
				...
				<span class="logo-lg">
					<img src="{$PAGE.ruta}img/logo.png" alt="VIP" style="width: 65px;"/>
				</span>
			...
			<!-- sidebar menu: : style can be found in sidebar.less -->
				<ul class="sidebar-menu">
					...
					<li class="header">MENÚ PRINCIPAL</li>
						...
						<li class="{if in_array($PAGE.modulo, array('asegurados', 'aseguradoras', 'estados'))}active{/if} treeview">
							<a href="#">
								<i class="fa fa-folder"></i>
								<span>Catálogos</span> <i class="fa fa-angle-left pull-right"></i>
							</a>
							<ul class="treeview-menu">
								<li {if $PAGE.modulo eq 'asegurados'}class="active"{/if}><a href="asegurados"><i class="fa fa-male"></i> Asegurados</a></li>
								<li {if $PAGE.modulo eq 'aseguradoras'}class="active"{/if}><a href="aseguradoras"><i class="fa fa-archive"></i> Aseguradoras</a></li>
								<li {if $PAGE.modulo eq 'estados'}class="active"{/if}><a href="estados"><i class="fa fa-star-half-o"></i> Estados</a></li>
							</ul>
						</li>
						{/if}
						
						{if in_array($PAGE.usuario->getTipo(), array(1, 2, 3))}
						<li class="{if in_array($PAGE.modulo, array('polizas', 'reportePolizas'))}active{/if} treeview">
							...
							<ul class="treeview-menu">
								...
								<li {if $PAGE.modulo eq 'reportePolizas'}class="active"{/if}><a href="reportePolizas"><i class="fa fa-print" aria-hidden="true"></i></i> Reporte</a></li>
							</ul>
						</li>
						{/if}
					</li>
