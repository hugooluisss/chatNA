<?php /* Smarty version Smarty-3.1.11, created on 2017-08-01 11:59:52
         compiled from "templates/plantillas/layout/default.tpl" */ ?>
<?php /*%%SmartyHeaderCode:87209174359808f7f802a73-03946203%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '87209174359808f7f802a73-03946203',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.11',
  'unifunc' => 'content_59808f7f9e47c9_23534509',
  'variables' => 
  array (
    'PAGE' => 0,
    'script' => 0,
...
<?php if ($_valid && !is_callable('content_59808f7f9e47c9_23534509')) {function content_59808f7f9e47c9_23534509($_smarty_tpl) {?><!DOCTYPE html>
<html>
	<head>
	<meta charset="utf-8">
...
img/logo.png" alt="VIP" style="width: 65px;"/>
				</span>
				<!-- logo for regular state and mobile devices -->
				<span class="logo-mini"><b>NA</b></span>
			</a>
			...
			<!-- sidebar menu: : style can be found in sidebar.less -->
				<ul class="sidebar-menu">
					...
					<li class="header">MENÚ PRINCIPAL</li>
						...
						<li class="<?php if (in_array($_smarty_tpl->tpl_vars['PAGE']->value['modulo'],array('asegurados','aseguradoras','estados'))){?>active<?php }?> treeview">
							<a href="#">
								<i class="fa fa-folder"></i>
								<span>Catálogos</span> <i class="fa fa-angle-left pull-right"></i>
							</a>
							<ul class="treeview-menu">
								<li <?php if ($_smarty_tpl->tpl_vars['PAGE']->value['modulo']=='asegurados'){?>class="active"<?php }?>><a href="asegurados"><i class="fa fa-male"></i> Asegurados</a></li>
								<li <?php if ($_smarty_tpl->tpl_vars['PAGE']->value['modulo']=='aseguradoras'){?>class="active"<?php }?>><a href="aseguradoras"><i class="fa fa-archive"></i> Aseguradoras</a></li>
								<li <?php if ($_smarty_tpl->tpl_vars['PAGE']->value['modulo']=='estados'){?>class="active"<?php }?>><a href="estados"><i class="fa fa-star-half-o"></i> Estados</a></li>
							</ul>
						</li>
						<?php }?>
						
						<?php if (in_array($_smarty_tpl->tpl_vars['PAGE']->value['usuario']->getTipo(),array(1,2,3))){?>
						<li class="<?php if (in_array($_smarty_tpl->tpl_vars['PAGE']->value['modulo'],array('polizas','reportePolizas'))){?>active<?php }?> treeview">
							...
							<ul class="treeview-menu">
								...
								<li <?php if ($_smarty_tpl->tpl_vars['PAGE']->value['modulo']=='reportePolizas'){?>class="active"<?php }?>><a href="reportePolizas"><i class="fa fa-print" aria-hidden="true"></i></i> Reporte</a></li>
							</ul>
						</li>
						<?php }?>
					</li>
